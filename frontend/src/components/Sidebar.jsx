...
export default function Sidebar({ onNavigate, settings, isLight, t }) {
  ...
  const allItems = [
    { k: "dashboard", icon: <Grid size={16} />, label: t('dashboard') },
    { k: "reports", icon: <FileText size={16} />, label: t('reports') },
    { k: "hierarchy", icon: <Layers size={16} />, label: t('hierarchy') },
    { k: "outstanding", icon: <DollarSign size={16} />, label: t('outstanding') },
    { k: "analyst", icon: <Printer size={16} />, label: t('analyst') },
    { k: "messaging", icon: <MessageCircle size={16} />, label: t('messaging') },
    { k: "usermanagement", icon: <Users size={16} />, label: t('usermanagement') },
    { k: "setting", icon: <Settings size={16} />, label: t('settings') },
    { k: "helpsupport", icon: <BookOpen size={16} />, label: t('helpsupport') },
  ];
